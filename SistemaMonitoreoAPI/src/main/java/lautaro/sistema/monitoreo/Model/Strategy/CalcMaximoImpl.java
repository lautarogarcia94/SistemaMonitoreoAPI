...
/**
 * Esta clase implementa la interfaz CalculoInt, para realizar el calculo del maximo valor de una cola
 */
@Component
public class CalcMaximoImpl implements CalculoInt {
    ...
    /**
     * Calcula el maximo valor dentro de la cola pasada por parametro. En caso de recibir
     * una cola vacia, loguea un warning y retorna el valor 0.0
     *
     * @param cola Queue<Integer> Cola sobre la cual se va a buscar el maximo
     * @return double Maximo de los valores de la cola.
     */
    @Override
